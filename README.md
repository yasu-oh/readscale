...
11. 輝度画像から 3x3 と 5x5 の局所差分を作り、細い文字や罫線を優先したエッジマスクを生成する
12. 弱い背景テクスチャをしきい値で落とし、広い写真・イラスト境界は少し抑える
13. マスクを軽く広げて、輪郭だけでなく文字ストローク全体へ補正が乗るようにする
14. エッジマスクを使って、輪郭部分を中心にアンシャープマスクを適用する
15. 輝度成分と色成分を再結合し、色味を軽く整える
16. JPEG の場合は必要に応じて透過部分を白背景に合成する
17. PNG / JPEG / WebP / BMP / TIFF など、出力パスの拡張子に合わせて保存する
